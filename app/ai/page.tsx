...
const items = [
  { title: "AI 콘텐츠 01", thumb: "/thumbs/ai_01.jpg" },
  { title: "AI 콘텐츠 02", thumb: "/thumbs/ai_02.jpg" },
  { title: "AI 콘텐츠 03", thumb: "/thumbs/ai_03.jpg" },
  { title: "AI 콘텐츠 04", thumb: "/thumbs/ai_04.jpg" },
];
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-10 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl mt-1">AI 콘텐츠</h1>
          </div>
