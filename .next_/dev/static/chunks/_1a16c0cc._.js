...
"[project]/app/branded/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BrandedPage() {
    ...
    const mapped = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BrandedPage.useMemo[mapped]": ()=>{
            return items.map({
                "BrandedPage.useMemo[mapped]": (it)=>{
            ...
            }["BrandedPage.useMemo[mapped]"]).filter({
                "BrandedPage.useMemo[mapped]": (it)=>it.id
            }["BrandedPage.useMemo[mapped]"]);
        }
    }["BrandedPage.useMemo[mapped]"], [
        items
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrandedPage.useEffect": ()=>{
            let cancelled = false;
            const run = {
                "BrandedPage.useEffect.run": async ()=>{
                    const pairs = mapped.map({
                        "BrandedPage.useEffect.run.pairs": (it)=>({
                                id: it.id,
                                url: it.youtubeUrl,
                                fallback: it.fallbackTitle || "YouTube Video"
                            })
                    }["BrandedPage.useEffect.run.pairs"]);
                    const next = {};
                    await Promise.all(pairs.map({
                        "BrandedPage.useEffect.run": async (p)=>{
                            try {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrandedPage.useEffect": ()=>{
            if (!openId) return;
            const onKey = {
                "BrandedPage.useEffect.onKey": (e)=>{
                    if (e.key === "Escape") setOpenId(null);
                }
            }["BrandedPage.useEffect.onKey"];
            window.addEventListener("keydown", onKey);
            return ({
                "BrandedPage.useEffect": ()=>window.removeEventListener("keydown", onKey)
            })["BrandedPage.useEffect"];
        }
    }["BrandedPage.useEffect"], [
        openId
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrandedPage.useEffect": ()=>{
            let cancelled = false;
            const mount = {
                "BrandedPage.useEffect.mount": async ()=>{
                    if (!openId) return;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrandedPage.useEffect": ()=>{
            const onFs = {
                "BrandedPage.useEffect.onFs": ()=>setIsFullscreen(!!document.fullscreenElement)
            }["BrandedPage.useEffect.onFs"];
            document.addEventListener("fullscreenchange", onFs);
            return ({
                "BrandedPage.useEffect": ()=>document.removeEventListener("fullscreenchange", onFs)
            })["BrandedPage.useEffect"];
        }
    }["BrandedPage.useEffect"], []);
    const togglePlay = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/app/branded/page.tsx",
                lineNumber: 430,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BrandedPage, "i5wAbz2dDs7fMV0Y1MDY7GRwdq4=", false, function() {
    return [
...
_c = BrandedPage;
var _c;
__turbopack_context__.k.register(_c, "BrandedPage");
...
//# sourceMappingURL=_1a16c0cc._.js.map